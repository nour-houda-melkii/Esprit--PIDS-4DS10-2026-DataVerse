...
class InflationAnalyzer:
    def __init__(self, column_name: str = "inflation"):
    ...
    def analyze(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        result["inflation_change"] = result[self.column_name].diff()
        ...
        result["inflation_score"] = result["inflation_change"].apply(compute_score)
